...
public class EventDAO {
    ...
    public void addEvent(Event event) {
        jdbcTemplate.update(
                "insert into event(name, description, start_date, end_date, start_time, end_time, capacity) values( :name, :description, :startDate, :endDate, :startTime, :endTime, :capacity)",
                Map.of(
                        "name",event.getName(),
